"""WeatherAPI.com: needs a free key. Up to 14 daily forecasts."""
...
class WeatherApiCom(Provider):
    ...
    async def fetch(self, client, lat, lon) -> List[DayForecast]:
        params = {"key": settings.weatherapi_key, "q": f"{lat},{lon}", "days": 14}
        resp = await client.get("https://api.weatherapi.com/v1/forecast.json", params=params)
